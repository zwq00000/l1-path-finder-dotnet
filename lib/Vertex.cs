...
namespace L1PathFinder {
  ...
  internal class Vertex : IPoint {
    ...
    static Vertex () {
      //Sentinel node
      NIL = new Vertex (int.MinValue, int.MinValue) {
        weight = double.NegativeInfinity
      };
    ...
    public static List<double> LANDMARK_DIST () {
      var res = new List<double> (NUM_LANDMARKS);
    ...
    //Topology
    public static Vertex CreateVertex (int x, int y) {
